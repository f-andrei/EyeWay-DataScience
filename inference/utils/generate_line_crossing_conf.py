...
def generate_nvdsanalytics_config_file(camera_name):
    try:
        ...
        config_content.extend([
            ...
            'enable=1',
            '',
            f'direction-Norte={width//2};{height};{width//2};{0}',
            f'direction-Sul={width//2};{0};{width//2};{height}',
            f'direction-Leste={0};{height//2};{width};{height//2}',
            f'direction-Oeste={width};{height//2};{0};{height//2}',
